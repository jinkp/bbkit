...
import (
	...
	"github.com/jinkp/bbkit/internal/opencode"
)
...
// OpenCodeWizardModel is the Bubbletea model for the bbk setup opencode wizard.
...
func (m OpenCodeWizardModel) viewDone() string {
	...
	body := successStyle.Render("bbkit MCP server written to:\n  ") + inputStyle.Render(targetPath)
	return renderWizardScreen(
		"bbkit setup opencode",
		"Done.",
		body,
